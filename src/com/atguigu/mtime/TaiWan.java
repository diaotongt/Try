...
import com.atguigu.mtime.XiangGang.MyAdapter;
import com.atguigu.mtime.XiangGang.ViewHolder;
...
public class TaiWan extends RankList_Top_Base {
	...
	public TaiWan(Context context, SubTopList subtoplist) {
		super(context);
