...
import com.atguigu.mtime.TaiWan.MyAdapter;
import com.atguigu.mtime.TaiWan.ViewHolder;
...
public class RiBen extends RankList_Top_Base {
	...
	public RiBen(Context context, SubTopList subtoplist) {
		super(context);
