...
import com.atguigu.mtime.discover.bean.File_Item_Bean;
 ...
 * @author Lupeng
 */
public class Discover_film_item extends Activity {
	...
	protected void progressdata(String response) {
		Gson gson = new Gson();
		File_Item_Bean file_item_bean = gson.fromJson(response,
				File_Item_Bean.class);
		// web_view.loadUrl(news_Item_Bean.url);
		// webView.loadDataWithBaseURL("http://www.3dmgame.com/", html,
		// "text/html","UTF-8", null);
		tv_item_title.setText(file_item_bean.title);
		String html = file_item_bean.content;
