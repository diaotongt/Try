...
import com.atguigu.mtime.RiBen.MyAdapter;
import com.atguigu.mtime.RiBen.ViewHolder;
...
public class HanGuo extends RankList_Top_Base {
	...
	public HanGuo(Context context, SubTopList subtoplist) {
		super(context);
