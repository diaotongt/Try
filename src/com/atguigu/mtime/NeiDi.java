...
import com.atguigu.mtime.BeiMei.MyAdapter;
import com.atguigu.mtime.BeiMei.ViewHolder;
...
public class NeiDi extends RankList_Top_Base {
	...
	public NeiDi(Context context, SubTopList subtoplist) {
		super(context);
